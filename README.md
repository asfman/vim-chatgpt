...
To use these commands (:Explain, :Review, :Fix or :Rewrite), visually select the lines of code you want to interact with, then type the desired command and press Enter.
